...
router.resource('/produtos/comandas', ProdutosComandasController ).apiOnly()
router.resource('/produtos/ingredientes', ProdutosIngredientesIngredientesController ).apiOnly()
